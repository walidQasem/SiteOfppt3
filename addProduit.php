...
<!--Table de affichage des produit-->
...
<script>
 ...
 //function confirm de suprimer un produit
    function supp(){
        alert('ok');
    }
    ...
    $('.add').hide();
    //function de afficher form pour ajouter un produit
    $(".lole").click(function(){
