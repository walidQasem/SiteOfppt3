      ...
      <select class=" m-auto info "   >
       ...
       <table class="table table-hover mt-5  table-striped ">
           ...
           foreach($sel as $me){
               ...
               <tr >
               <td><b  scope='row' class='gop'>".$me['idB']."</b></td>
               <td><b class='gop'>".$me['titleP']."</b></td>
               <td><b class='gop'  style='color:blue;'>".$me['DateB']."</b></td>
               <td><b class='gop'>".$me['disctiptionB']."</b></td>
               <td><b class='gop'>".$me['NomL']."</b></td>
               </tr>
