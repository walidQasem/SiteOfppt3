...
<div class="d-flex align-items-center">
    <img src="image/pc.png" style="width:80px;">
    <div>
        <b style="font-size:12px;">Women Colorblock Sneakers</b><br>
        <b style="color: blue;">1255.01$</b>
    </div>
</div>
...
<b style="color:grey;font-size:11px;"  class="me-5">Subtotal:</b><b class="ms-auto mx-5">2200.02$</b><br>
